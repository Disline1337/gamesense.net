...
void SetupOffsets()
{
	...
	offys.dwInitKeyValues = Utilities->Memory_PatternScan(Cheat::Settings->ClientDLL, (xorstr_("55 8B EC 51 33 C0 C7 45")));
...
bool Cheat::Initialize()
{
	...
	if ( !Settings->UIDevMode )
	{
		...
		G::ClientModeManager.Hook( 22, CreateMoveHook );
		oCreateMove = G::ClientModeManager.GetOriginal<fnCreateMove>( 22 );
		...
		static auto dwMove = Utilities->Memory_PatternScan("engine.dll", "55 8B EC 81 EC ? ? ? ? 53 56 8A");
